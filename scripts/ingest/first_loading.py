...
from multimodal_extraction.config import CHUNK_OVERLAP, CHUNK_SIZE, EMBED_MODEL_ID
...
from multimodal_extraction.utils import compute_stats, get_console_logger
